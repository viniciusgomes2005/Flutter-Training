...
import 'package:pet_app/clinics.dart';
import 'class_veterinary.dart';
import 'doc_clinic.dart';
...
class _SpecialistsState extends State<Specialists> {
  ...
  List<Veterinary>veterinaryList=allVeterinaries;
  @override
            ...
            Wrap(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed:() {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: ((context) => const Clinics())));
                  },
                  child: const Text("Clinics",style: TextStyle(color: Colors.black),),)]),
            SizedBox(
              width: 200,
              height: 32,
              child: TextField(
  ...
  void searchDoc(String textInput){
    final suggestions = allVeterinaries.where((veterinary){
    ...
    setState(()=>veterinaryList=suggestions);
  }
}
